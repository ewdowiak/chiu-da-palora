...
sub make_alfa_welcome {
    ...
    ## output to html
    my $othtml ;
    $othtml .= '<div><h3 style="margin-top: 0em;">Dizziunariu Dieli</h3></div>' . "\n" ; 
    ...
    $othtml .= '<div class="row" style="margin: 20px 20px 5px 20px; border: 1px solid black; background-color: rgb(255,255,204);">'."\n";
    ## $othtml .= '  <div class="col-1"></div>'."\n";
    $othtml .= '  <div class="col-m-12 col-6" style="padding: 0px 20px 0px 25px;">'."\n";
    $othtml .= "\n";
    $othtml .= '<h3>pulìtica di la risirvatizza</h3>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Stu situ web nun nfurna biscotti.  Si voi manciari biscotti, ti preju di jiri a lu'."\n";
    $othtml .= ' panificiu chiù vicinu.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Stu situ web reggistra lu to ndrizzu IP e l'."'".'agenti utenti dû to browser,'."\n";
    $othtml .= ' ma in generali nun vogghiu ricògghiri la to informazioni pirsunali.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Chiddu ca vogghiu ricògghiri è informazioni di palori siciliani.  Speru ca mi aiuti.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Pi sapiri cui furnisci informazioni di palori siciliani, ti dumannu dû to nomu.'."\n";
    $othtml .= ' Ma nun ti custrinciu a rivelari sta informazioni o qualsiasi àutra informazioni.  Si mi dici lu to nomu,'."\n";
    $othtml .= ' allura presumu di aviri lu cunsensu esplicitu necessariu ê sensi dû regulamentu UE 2016/679 pi'."\n";
    $othtml .= ' ricògghiri l'."'".'informazioni ca furnisci.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Usu l'."'".'informazioni ca furnisci pi sviluppari un dizziunariu sicilianu,'."\n";
    $othtml .= ' ma nun spàrtisciu la to informazioni pirsunali cu àutri.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">L'."'".'unica cosa ca vogghiu è informazioni di palori siciliani.'."\n";
    $othtml .= ' Mi dici chiù di sti palori?</p>'."\n";
    $othtml .= "\n";
    ...
    $othtml .= '  <div class="col-m-12 col-6" style="padding: 0px 20px 0px 25px;">'."\n";
    $othtml .= "\n";
    $othtml .= '<h3>privacy policy</h3>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">This website does not bake cookies. If you want to eat cookies, please visit'."\n";
    $othtml .= ' your local bakery.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">This website does record your IP address and your browser'."'".'s user agent,'."\n";
    $othtml .= ' but in general I do not want to collect your personal infomation.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">What I want to collect is information about Sicilian words. I hope you will help me.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">So that I know who is providing information on Sicilian words, I ask you to'."\n";
    $othtml .= ' tell me your name.  But I do not require this information or any other information.  If you tell me your name,'."\n";
    $othtml .= ' then I assume that I have the explicit consent necessary under EU regulation 2016/679 to collect the information'."\n";
    $othtml .= ' that you provide.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">I will use the information that you provide to develop a Sicilian dictionary,'."\n";
    $othtml .= ' but I will not share your personal data with others.</p>'."\n";
    $othtml .= "\n";
...
#    $ottxt .= '      #closeme:target {  display: block; }' . "\n" ;
    ...
    $ottxt .= '      <h1 style="margin-bottom: 0.5em;">Aiùtami!</h1>' . "\n" ;
...
sub offer_translation {
	...
	$othtml .= '<span class="lightcolor">Mi dici chiù di sta palora?</span></i></p>' . "\n" ; 
    } else {
	...
	$othtml .= '<p style="margin-top: 0.5em; margin-bottom: 0.25em; text-align: center;"><i>' ;
	$othtml .= '<span class="lightcolor">Mi dici chiù di sta palora puru?</span></i></p>' . "\n" ; 
    }
    ##  inner DIV
...
sub make_poetry {
    ...
    $othtml .= 'Canusci na puema o un pruverbiu tipicu di sta palora?  Scrivilu ccà!</span></i></p>' . "\n" ; 
...
sub make_welcome_msg {
    ...
    $othtml .= "\n";
    $othtml .= '<!-- begin row div -->'."\n";
    $othtml .= '<div class="row" style="margin: 0px 20px 20px 20px; border: 1px solid black; background-color: rgb(255,255,204);">'."\n";
    ## $othtml .= '  <div class="col-1"></div>'."\n";
    $othtml .= '  <div class="col-m-12 col-6" style="padding: 0px 20px 0px 25px;">'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 1.2em;"><i>Mi aiuti a annutari nu dizziunariu sicilianu?</i></p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p>Cercu grammàtica, puisìa e pruverbi pi li palori siciliani ntô '."\n";
    $othtml .= '  <i><a href="/cgi-bin/sicilian.pl">Dizziunariu Dieli</a></i>.'."\n";
    $othtml .= '  Di sutta c'."'".'è un ìnnici a la opira di '."\n";
    $othtml .= '  <a href="http://www.dieli.net/" target="_blank">Arthur Dieli</a>.</p>'."\n";  
    $othtml .= "\n";
    $othtml .= '<p>Sunnu dispunìbbili du'."'".' modi:  '."\n";
    $othtml .= '  "<a href="/cgi-bin/aiutami.pl?lastauto=auto">modu automaticu</a>" e "modu navigatu."'."\n";  
    $othtml .= '  Modu automaticu dumanna informazioni a palori scigghiuti aliatoriamenti &ndash; una doppu l'."'".'àutra.'."\n";  
    $othtml .= '  Modu navigatu ti torna a la pàggina di cuntinuti doppu ca avisti annutatu na palora.</p>'."\n" ; 
    $othtml .= "\n";
    $othtml .= '<p>Pi cuminciari, clicca supra una dî link di sutta.'."\n";
    $othtml .= '  O clicca ccà pi: &nbsp; <a href="/cgi-bin/aiutami.pl?lastauto=auto">modu automaticu</a>.</p>'."\n" ; 
    $othtml .= "\n";
    $othtml .= '  </div>'."\n";   
    $othtml .= '  <div class="col-m-12 col-6" style="padding: 0px 10px 0px 25px;">'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 1.2em;"><i>Could you help me annotate a Sicilian dictionary?</i></p>'."\n";
    $othtml .= "\n";    
    $othtml .= '<p>I'."'".'m looking for grammar, poetry and proverbs about the Sicilian words in the '."\n";
    $othtml .= '  <i><a href="/cgi-bin/sicilian.pl">Dieli Dictionary</a></i>. Below is an index of '."\n";
    $othtml .= '  <a href="http://www.dieli.net/" target="_blank">Arthur Dieli</a>'."'".'s work.</p>'."\n"; 
    $othtml .= "\n";
    $othtml .= '<p>Two modes are available: &nbsp; "<a href="/cgi-bin/aiutami.pl?lastauto=auto">auto-mode</a>" and "browse-mode."'."\n";
    $othtml .= '  Auto-mode solicits contributions to randomly selected words &ndash; one word automatically following another.'."\n";
