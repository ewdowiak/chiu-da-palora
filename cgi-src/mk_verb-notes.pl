...
%{ $vnotes{"manciari"} } = (
    ...
    poetry => ["Diventa poviru e servu, quannu i paroli non figghianu paroli e si mancianu tra d'iddi. (Gnazziu Buttitta)",],
    part_speech => "verb",
    verb => {
	conj => "ciari", 
	stem => "manci" ,
...
%{ $vnotes{"parrari"} } = (
    ...
    poetry => ["Parru cu tia, to è la curpa. (Gnazziu Buttitta)",],
    part_speech => "verb", 
    verb => {
	conj => "xxari", 
	stem => "parr" ,
